...
convertBtn.addEventListener("click", () => {
  lengthResult.innerHTML = `${inputNumber.value} meters = ${(inputNumber.value * 3.281).toFixed(3)} feet | ${inputNumber.value} feet = ${(inputNumber.value / 3.282).toFixed(3)} meters`;
